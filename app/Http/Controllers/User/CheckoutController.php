    ...
    public function update_shipping_address(Request $request)
{
    ...
    $request->session()->put('address_id', $shipping_address->id);

    return redirect()->route('user.payment')->with('success', 'Shipping address added successfully');
    ...
    function payment()
    {
        ...
        return view('user.payment', compact('shipping_address'));
    }
    ...
    function checkout_submit_cash_on_delivery(Request $request)
    {
        ...
        $qlys = Cart::whereUserId(auth()->id())->pluck('qty');
        ...
        $order->qlys = json_encode($qlys);
        $order->payment_method = $request->payment_method;
        $order->address_id = $request->session()->get('address_id');
