        ...
        <div class="row">
            ...
            <div class="col-xxl-5 col-lg-6 col-md-6">
                <div class="product-gallery">
                    {{-- <span class="product-badge bg-dark">Tốt nhất</span>
                ...
                <div class="details-page-top-right-content d-flex align-items-center">
                    <div class="div w-100">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-success  d-inline-block">Trong kho</span>
                        </div>
                        ...
                        <p class="text-muted">{{ $product->short_description }} <a href="#details" class="scroll-to">Đọc thêm</a></p>
                        ...
                        <div class="div">
                            <div class="t-c-b-area">
                                ...
                                <div class="pt-1 mb-1"><span class="text-medium">Thể loại:</span>
                                    <a
                            ...
                            <div class="mt-4 p-d-f-area">
                                <div class="left">
                                    <a class="btn btn-primary btn-sm wishlist_store wishlist_text"
                                        ...
                                        <span class="wishlist1">Danh sách yêu thích</span>
                                        <span class="wishlist2 d-none">Đã thêm vào danh sách yêu thích</span>
                                    </a>
                                    <a class="btn btn-primary btn-sm  product_compare"
                                        href="{{ route('user.add_to_compare', ['id' => $product->id]) }}"><span><i
                                                class="icon-repeat"></i>So sánh</span></a>
                                </div>

                                {{-- <div class="d-flex align-items-center">
                                    <span class="text-muted mr-1">Chia sẻ: </span>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h2 class="h3">Bạn cũng có thể thích</h2>
                </div>
            </div>
        </div>
        <div class="row g-3">
