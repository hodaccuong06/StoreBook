                            ...
                            @foreach ($sliders as $slider)
                                <div class="item" style="background: url('{{ asset('storage') }}/{{ $slider->image }}')">
                                    <div class="item-inner">
                                        ...
                                        <a class="btn btn-primary scale-up delay-1" href="{{ $slider->url }}"> <span>Mua ngay</span>
                                        </a>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="product-card">
                                    <div class="product-thumb">
                                        ...
                                        <div class="product-button-group">
                                            ...
                                            @else
                                                <a class="product-button wishlist_store"
                                                    href="{{ route('user.login') }}" title="Wishlist"><i
    ...
    <div class="deal-of-day-section mt-20">
        <div class="container">
            ...
            <div class="row g-3">
                <div class="col-lg-12">
                    <div class="popular-category-slider owl-carousel">
                        @foreach ($categories4->products as $product)
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        <img class="lazy"
                                    ...
                                    <div class="product-card-body">
                                        <div class="product-category"><a href="/shop/category/{{ $categories4->slug }}">{{ $categories4->name }}</a>
                                        </div>
                                        <h3 class="product-title"><a
                                                href="{{ route('user.product_details', ['slug' => $product->slug]) }}">
                                                {{ \Illuminate\Support\Str::substr($product->name, 0, 50) }}
    ...
    <div class="bannner-section mt-60">
        <div class="container ">
            <div class="row gx-3">
                <div class="col-md-4">
                    <a href="#" class="genius-banner">
                        <img src="{{ asset('storage') }}/{{ $four_three_column_value->image1 }}" alt="">
                        <div class="inner-content">
                            <p>{{ $four_three_column_value->title1 }}</p>
                            <h4>{{ $four_three_column_value->sub_title1 }}</h4>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="#" class="genius-banner">
                        <img src="{{ asset('storage') }}/{{ $four_three_column_value->image2 }}" alt="">
                        <div class="inner-content">
                            <p>{{ $four_three_column_value->title2 }}</p>
                            <h4>{{ $four_three_column_value->sub_title2 }}</h4>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="#" class="genius-banner">
                        <img src="{{ asset('storage') }}/{{ $four_three_column_value->image3 }}" alt="">
                        <div class="inner-content">
                            <p>{{ $four_three_column_value->title3 }}</p>
                            <h4>{{ $four_three_column_value->sub_title3 }}</h4>
                        </div>
                    </a>
                </div>
            </div>
