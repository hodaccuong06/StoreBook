                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><a class="btn btn-sm btn-primary"
                                                href="{{ route('user.wishlist.clear') }}"><span>Xóa danh sách yêu thích</span></a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <td>
                                                <div class="product-item"><a class="product-thumb"
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <div class="text-sm">Khả dụng:
                                                            <div class="d-inline text-success">Trong kho</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <a class="product-button btn btn-primary btn-sm add_to_single_cart"
                                                    href="{{ route('user.add_to_cart', ['id'=>$wishlist->product->id]) }}"><i
                                                        class="icon-shopping-cart"></i><span>Vào giỏ hàng</span>
                                                </a>
                                            </td>
