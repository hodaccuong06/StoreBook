                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><a class="btn btn-sm btn-primary" href="{{ route('user.cart.clear') }}"><span>Xóa giỏ hàng</span></a>
                                    </th>
                                </tr>
                            </thead>
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <div class="shopping-cart-footer">
                        <div class="text-right text-lg column d-none"><span class="text-muted">Giảm giá () : </span><span
                                class="text-gray-dark">$0.00</span></div>

                        <div class="text-right column text-lg"><span class="text-muted">Tổng: </span><span
                    ...
                    <div class="shopping-cart-footer">
                        ...
                        <div class="column"><a class="btn btn-primary"
                                href="{{ route('user.checkout') }}"><span>Thủ tục thanh toán</span></a>
                        </div>
                    </div>
                </div>
            </div>
