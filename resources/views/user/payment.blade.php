        ...
        <div class="container">
            <div class="column">
                <ul class="breadcrumbs">
                    ...
                    <li>Xem lại đơn hàng của bạn và thanh toán</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row padding-top-1x  mb-4">
                            <div class="col-sm-12">
                                ...
                                <ul class="list-unstyled">
                                    <li><span class="text-muted">Tên: </span>{{ Auth::user()->name }}</li>
                                    <li><span class="text-muted">Điện thoại: </span>{{ $shipping_address->phone }}</li>
                                    <li><span class="text-muted">Địa chỉ 1: </span>{{ $shipping_address->address1 }}</li>
                                    <li><span class="text-muted">Địa chỉ 2: </span>{{ $shipping_address->address2 }}</li>
                                    <li><span class="text-muted">Thành phố: </span>{{ $shipping_address->city }}</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title">Giao dịch tiền mặt khi giao hàng</h6>
                            ...
                            <form action="{{ route('user.checkout.cash.on.delivery') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <p>Trả tiền khi giao hàng về cơ bản có nghĩa là bạn sẽ thanh toán số lượng sản phẩm trong khi nhận được hàng được giao cho bạn.</p>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-primary btn-sm" type="button"
                                        data-bs-dismiss="modal"><span>Hủy bỏ</span></button>
