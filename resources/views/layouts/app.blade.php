                    ...
                    <div class="col-md-4">
                        <div class="t-m-s-a">
                            <a class="track-order-link compare-mobile d-lg-none"
                                href="{{ route('user.compare') }}">So sánh</a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="right-area">
                            ...
                            <a class="track-order-link wishlist-mobile d-inline-block d-lg-none"
                                href="{{ route('user.wishlist') }}"><i
                                    class="icon-heart"></i>Danh sách yêu thích</a>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="toolbar d-flex">
                                ...
                                <div class="toolbar-item hidden-on-mobile"><a href="{{ route('user.compare') }}">
                                        <div><span class="compare-icon"><i class="icon-repeat"></i>
                                        @auth<span
                                        
                                                    class="count-label compare_count">{{ \App\Models\Compare::where('user_id', auth()->id())->count() }}</span> @endauth</span><span
                                                class="text-label">So sánh</span></div>
                                    </a>
                                </div>
                                <div class="toolbar-item hidden-on-mobile"><a href="{{ route('user.wishlist') }}">
                                        <div>
                                            ...
                                            @auth<span
                                                ...
                                                @endauth</span><span class="text-label">Yêu thích</span>
                                        </div>
                                    </a>
                                </div>
                                <div class="toolbar-item"><a href="">
                                        ...
                                        @auth<span
                                                ...
                                                @endauth</span><span class="text-label">Giỏ hàng</span></div>
                                    </a>
                                    @php
                                    ...
                                    <div class="toolbar-dropdown cart-dropdown widget-cart  cart_view_header"
                                        ...
                                        <div class="text-right">
                                            <p class="text-gray-dark py-2 mb-0"><span
                                                    class="text-muted">Tổng:</span> ${{ $sub_total }}</p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                    ...
                                    <nav class="slideable-menu">
                                        <ul>
                                            <li class="{{ Request::routeIs('user.home') ? 'active':''}}"><a href="/"><i
                                                        class="icon-chevron-right"></i>Trang chủ</a></li>
                                            <li class="{{ Request::routeIs('user.shop') ? 'active':''}}"><a href="{{ route('user.shop') }}"><i
                                                        class="icon-chevron-right"></i>Cửa hàng</a></li>
                                            ...
                                            <li class="{{ Request::routeIs('user.brand') ? 'active':''}}"><a
                                                    href="{{ route('user.brand') }}"><i
                                                        class="icon-chevron-right"></i>Tác giả</a></li>
                    ...
                    <div class="col-lg-3">
                        <div class="left-category-area">
                            <div class="category-header">
                                <h4><i class="icon-align-justify"></i> Tất cả danh mục</h4>
                            </div>
                            <div class="category-list">
                                ...
                                @foreach ($categories1 as $category)
                                    <div class="c-item">
                                        <a class="d-block navi-link" href="{{ route('user.category.product', ['slug' => $category->slug]) }}">
                                            ...
                                            @foreach ($category->sub_category as $sub_category)
                                                <div class="child-c-box">
                                                    <a class="title" href="/shop/category/{{ $sub_category->id }}/{{ $category->id }}">
                                                        {{ $sub_category->name }}
                                                        @if ($sub_category->child_category->isNotEmpty())
                                                            <i class="icon-chevron-right"></i>
                                                        @endif
                                                    </a>
                                                    @if ($sub_category->child_category->isNotEmpty())
                                                        <div class="child-category">
                                                            @foreach ($sub_category->child_category as $child_category)
                                                                <a href="/shop/category/{{ $child_category->id }}/{{ $category->id }}/{{ $sub_category->id }}">{{ $child_category->name }}</a>
                                                            @endforeach
                                                        </div>
                                                    @endif
                                                </div>
                                ...
                                <a href="{{ route('user.category') }}"
                                    ...
                                    <img class="lazy"
                                        ...
                                        alt="">
                                    <span class="text-gray-dark">Tất cả danh mục</span>
                                </a>
                            </div>
                        ...
                        <div class="nav-inner">
                            <nav class="site-menu">
                                <ul>
                                    ...
                                    <li class="{{ Request::routeIs('user.shop') ? 'active':''}}"><a href="{{ route('user.shop') }}">Cửa hàng</a></li>
                                    <li class="{{ Request::routeIs('user.category') ? 'active':''}}"><a href="{{ route('user.category') }}">Danh mục</a>
                                    </li>
                                    <li class="{{ Request::routeIs('user.brand') ? 'active':''}}"><a href="{{ route('user.brand') }}">Tác giả</a></li>
                                    <li class="{{ Request::routeIs('user.blog') ? 'active':''}}"><a
                                            href="{{ route('user.blog') }}">Blog</a></li>
                                            {{-- <li class="{{ Request::routeIs('user.blog') ? 'active':''}}"><a
                                                href="{{ route('user.blog') }}">Liên hệ</a></li> --}}
...
<div id="announcement-modal" class="mfp-hide white-popup">
    <div class="announcement-with-content">
        <div class="left-area">
            <img src="http://127.0.0.1:8000/storage/media_value/sale.png"
                alt="">
        </div>
        <div class="right-area">
            <h3 class="">Nhận giảm giá 50%.</h3>
            <p>Hãy nhập email để được nhận mã giảm giá</p>
            <form class="subscriber-form" method="post">
                ...
                <button class="btn btn-primary btn-block mt-2" type="button" class="mfp-close">
                    <span>Nhận</span>
                </button>
            </form>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <section class="widget widget-light-skin">
                        <h3 class="widget-title">Liên lạc</h3>
                        <p class="mb-1"><strong>Địa chỉ: </strong> {{ $footer_value->address }}</p>
                        <p class="mb-1"><strong>Điện thoại: </strong> {{$footer_value->phone}}</p>
                        <p class="mb-3"><strong>Email: </strong> {{ $footer_value->email }}</p>
                        <ul class="list-unstyled text-sm">
                            <li><span class=""><strong>Thứ hai - thứ Sáu: </strong></span>9:27 PM - 9:27 PM</li>
                            <li><span class=""><strong>Thứ bảy: </strong></span>9:27 PM - 9:27 PM</li>
                        </ul>
                ...
                <div class="col-lg-4">
                    ...
                    <section class="widget">
                        ...
                        <form class="row subscriber-form"
                            ...
                            <div class="col-sm-12">
                                <button class="btn btn-primary btn-block mt-2" type="submit" class="mfp-close">
                                    <span>Subscribe</span>
                                </button>
                            </div>
                        </form>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Lắng nghe sự kiện click trên nút "Nhận"
        document.querySelector('#announcement-modal .subscriber-form button').addEventListener("click", function() {
            // Đóng modal bằng cách gọi phương thức đóng của Magnific Popup
            $.magnificPopup.close();
        });
    });
</script>
